	...
	public List<Paciente>listarPacientes(){
		...
		try {
			...
			while (rs.next()) {
				...
				paciente = new Paciente(rs.getInt("fichamedica_idFichaMedica"),rs.getInt("idPersona"),rs.getString("dni"),rs.getString("apellido"),rs.getString("nombre"),rs.getDate("fechaNac"),rs.getString("sexo"),rs.getString("telefono"),rs.getString("email"),rs.getString("domicilio"),rs.getInt("cuenta_id_cuenta"),rs.getInt("fichamedica_idFichaMedica"));
